<a href="{{ route('brand.show', $item->id) }}" class="block hover:shadow-xl transition product-card">
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100">
        <div class="h-52 w-full relative product-image-container mb-3">
            @if(!empty($item->image))
            ...
            <div class="hover-overlay">
                <div class="overlay-badge bg-white/80 text-sm px-3 py-2 rounded-full font-semibold">Lihat Selengkapnya</div>
            </div>
        </div>
        <div class="p-6">
